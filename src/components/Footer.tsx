...
export const Footer: FC<Props> = (props) => {
    return (<div className='bg-not-quite-black flex flex-col'>
        <div className="pt-20 gap-x-4 gap-y-0 text-white grid grid-cols-4 grid-rows-100 container mx-auto px-6 columns-xs
        md:grid-cols-8
        ...
        <div className="pb-16 grid-cols-4 grid-rows-1 gap-x-4 text-white container mx-auto px-6">
            <LogoCTA />
        </div>
        </div>)
}
...
const ProductLinks: FC = () => {
    ...
    return (
        <div className="flex flex-col col-start-1 col-end-3 mb-10 row-span-1
        md:col-start-5 md:col-end-7">
            <span className='text-blurpleButton pt-2'>Product</span>
            {productLinks.map((link, index) => {
                return (
                    <a key={index} href="" className="text-white mt-2">
                        {link}
                    </a>
                );
            })
...
const CompanyLinks: FC = () => {
    ...
    return (
        <div className="flex flex-col mb-10 col-start-3 col-end-5 row-span-1
        md:col-start-7 md:col-end-9">
            <span className='text-blurpleButton pt-2'>Company</span>
...
const ResourcesLinks: FC = () => {
    const resourcesLinks = ['College', 'Support', 'Safety', 'Blog', 'Feedback', 'Build', 'StreamKit', 'Creators', 'Community'];
    return (
        <div className="flex flex-col col-start-1 col-end-3 mb-10
        md:col-start-5 md:col-end-7
        lg:col-start-9 lg:col-end-11">
            <span className='text-blurpleButton pt-2'>Resources</span>
...
const PoliciesLinks: FC = () => {
    const policiesLinks = ['Terms', 'Privacy', 'Cookie Settings', 'Guidelines', 'Acknowledgements', 'Licenses', 'Moderation'];
    return (
        <div className="flex flex-col col-start-3 mb-10 col-end-5
        md:col-start-7 md:col-end-9
        lg:col-start-11 lg:col-end-13">
            <span className='text-blurpleButton pt-2'>Policies</span>
...
const LogoCTA: FC = () => {
    return (
        <div className="">
            <div className="pb-8 border-t border-blurpleButton"></div>
            <div className="flex items-center justify-between">
                <a href="" className="">
                    <DiscordLogo />
                </a>
                <Button className='py-[7px] px-4 rounded-full bg-blurpleButton hover:bg-blurpleHover font-gg-sans font-medium'>
                    Sign up
                </Button>
            </div>
        </div>
